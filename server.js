...
var config = {
    user: 'chetanpaliwalcool',
    database: 'chetanpaliwalcool',
...
var articles = {
    'article-one': {
    title:'Article One | Chetan Paliwal',
  heading:'Article One',
  date:'August 08, 2017',
  content: `
            <p>
    ...
    'article-two' : {  title:'Article Two | Chetan Paliwal',
  heading:'Article Two',
  date:'August 08, 2017',
  content: `
            <p>
  ...
  content: `
            <p>
                 This is the first content of my third article. This is the content of my third article.
            </p>`
...
app.get('/articles/:articleName',function(req, res) {
  ...
  pool.query("SELECT * FROM article WHERE title = '" + req.params.articleName + "'", function(err , reult){
     if(err){
         res.status(500).send(err.toString());
     } else{
